...
Servo::Servo(uint8_t address, double low_limit, double high_limit, bool reset)
{
	/**
...
void Servo::angle(uint8_t channel, float angle)
{
	/**
  ...
  float fangle=angle+90.00f; 
  uint16_t position= fangle*(4095.00f/180.0f);

  move(channel,position,4095);
